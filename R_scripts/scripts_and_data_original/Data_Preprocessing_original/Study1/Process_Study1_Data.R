######
# Script for processing of raw Expt1 data
# Note that due to a technical issue (an unbacked up computer) we no
# longer have access to all of the initial raw data from participants. 
# We have full access to the datafiles in which minor spelling mistakes
...
write_csv(data, "study1_English.csv")
